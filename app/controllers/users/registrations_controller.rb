...
class Users::RegistrationsController < Devise::RegistrationsController
    ...
    def create
        super do |resource| # resource is the data from HTML, in this case is User registration info
            if params[:plan] # if do have :plan params have been submit with form
                ...
                if resource.plan_id == 2
                    resource.save_with_payment # If this resource comes from plan_id=2, saves by special way. The custom function is define at user.rb Model
                else
